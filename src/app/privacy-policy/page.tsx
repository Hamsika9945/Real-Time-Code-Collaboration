...
export default function PrivacyPolicyPage() {
  return (
    <AppLayout>
      <Header userCount={0} />
      <AnimatedBackground title="Privacy Policy" subtitle="-Your privacy matters to us"><div/></AnimatedBackground>
            ...
            >
              ...
              <div className="prose dark:prose-invert mx-auto max-w-3xl flex flex-col gap-4">
                ...
                <ul className="list-disc pl-5 md:pl-8">
                  <li>
                    <strong>Personal Information:</strong> Name, email address, and other details
                    you provide when signing up or contacting us.
                  </li>
                  <li>
                    <strong>Usage Data:</strong> Information on how you use the platform, including
